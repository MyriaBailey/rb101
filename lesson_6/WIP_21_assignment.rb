...
Outer Game Loop
- [ ] Play a round of 21 (Inner Game Loop)
...
Inner Game Loop:
- [ ] Initialize the deck
- [ ] `initialize_deck` method call:
  - [ ] `cards` = empty array
  - [ ] On a range of ints 2 - 10 inclusive:
        - Create 4 hashes ea. of name: int as str, val: int + add to cards
  - [ ] For strings (jack queen king) each,
        - Create 4 hashes name: str_name, val: 10 + add to cards
  - [ ] Add 4 hashes name: ace, val: 11 + add to cards
  - [ ] Return a shuffled cards array and close the method

- [ ] Initialize player/dealer hands/totals as a hash each
